...
class BattleScene extends Phaser.Scene{
  ...
  drawBaseBar(){const hp=Math.max(0,Math.ceil(this.baseHP));this.baseBar.clear().fillStyle(0x0c1b38,.9).fillRoundedRect(22,17,330,40,10).lineStyle(2,0x5d80b3).strokeRoundedRect(22,17,330,40,10).fillStyle(0xffffff,.95).fillRoundedRect(168,30,142,12,5).fillStyle(this.baseHP>35?0x47d65b:0xef4f55).fillRoundedRect(170,32,138*this.baseHP/100,8,4);this.baseLabel?.destroy();this.basePercent?.destroy();this.baseLabel=this.add.text(35,28,'🏰 สวนลอยฟ้า',{font:'bold 15px Arial',color:'#ffffff',stroke:'#071329',strokeThickness:2}).setDepth(21);this.basePercent=this.add.text(318,28,`${hp}%`,{font:'bold 14px Arial',color:'#ffffff',stroke:'#071329',strokeThickness:2}).setOrigin(.5,0).setDepth(21)}
