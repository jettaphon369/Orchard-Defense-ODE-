...
{id:'thorn',name:'Thorn Guardian',icon:'🌵',texture:'thorn',cost:210,role:'ยิงสาม',hp:240,damage:16,rate:1100,range:900,cool:7500,shots:3},
{id:'frostberry',name:'Frost Berry',icon:'🧊',texture:'frostberry',cost:175,role:'น้ำแข็ง',hp:120,damage:28,rate:1200,range:900,cool:6500,slow:true},
...
{id:'dragonfruit',name:'Dragon Fruit',icon:'🐉',texture:'dragonfruit',cost:260,role:'แทงค์ยิงคู่',hp:600,damage:26,rate:1400,range:900,cool:9000,shots:2},
...
{id:'pumpkinking',name:'Pumpkin King',icon:'🎃',texture:'pumpkinking',cost:250,role:'ระเบิดใหญ่',hp:220,damage:220,rate:0,range:110,cool:10000,mine:true}
];
...
class BattleScene extends Phaser.Scene{
  ...
  upgradeUnit(u){
    ...
    if(!SANDBOX_MODE)state.energy-=cost;u.level++;if(!SANDBOX_MODE)updateProgress(s=>{s.stats.upgrades++;s.daily.upgrades++;});u.maxHp=Math.floor(u.maxHp*1.45);u.hpVal=u.maxHp;
