...
## V6.3 HUD Clarity
- ย้ายปุ่มเสียงและหยุดเกมขึ้นแถวชื่อเกม
- แถวสถานะเหลือ 5 ช่องเท่ากัน ทำให้ตัวเลขเวฟแสดงครบ
- แถบบอสแบบแนวนอนบาง วางในพื้นที่ท้องฟ้า ไม่บังสนาม


## V6.4 Placement Cancel + Boss HUD Fit
- เลื่อนแถบเลือดบอสขึ้นไปอยู่ในพื้นที่ท้องฟ้ามากขึ้น ไม่บังช่องต่อสู้
- แตะพื้นที่ว่างนอกตารางเพื่อยกเลิกการ์ดที่กำลังเลือก
- หากเลือกการ์ดค้างไว้แล้วแตะยูนิตเดิม ระบบจะยกเลิกการ์ดและเปิดอัปเกรดยูนิตทันที
